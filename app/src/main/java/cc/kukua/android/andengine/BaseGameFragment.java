...
public abstract class BaseGameFragment extends BaseFragment implements IGameInterface, IRendererListener {
    ...
    public Engine onCreateEngine(EngineOptions pEngineOptions) {
        pEngineOptions = new EngineOptions(pEngineOptions.isFullscreen(),ScreenOrientation.PORTRAIT_FIXED,pEngineOptions.getResolutionPolicy(),pEngineOptions.getCamera());
